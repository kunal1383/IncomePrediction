...
class Prediction_Raw_Data_Validation:
    """
    Class is used for validation of raw Prediction data.
    ...
    def manualRegexCreation(self):
        """
            ...
            On Failure: None
        """
        # pattern is "incomeDate" + "_" + "DateStamp _" + "TimeStamp"
    ...
    def moveBadFilesToArchive(self):
        ...
        try:
            ...
            if os.path.isdir(source):
                ...
                # only movings those files which were not archived
                for f in files:
    ...
    """
        try:
            ...
            self.logger.log(f,"Validation of Column lenght Started")
    ...
    def validateMissingValuesInWholeColumn(self):
        ...
        try:
            ...
            self.logger.log(f,"Checking for Empty column started!!")
            ...
            for file in listdir('Prediction_Raw_files_validated/Good_Raw/'):
                ...
                for columns in csv:
                    ...
                    # The len(csv[columns]) returns the total number of elements in the columns column of the CSV file. The csv[columns].count() returns the number of non-null values in that column.
                    # So, len(csv[columns]) - csv[columns].count() returns the number of null values in the columns column of the CSV file.
                    # Finally, the boolean expression == len(csv[columns]) checks whether the number of null values in the columns column is equal to the total number of elements in that column. If the expression evaluates to True, it means that all the values in the columns column are null. 
